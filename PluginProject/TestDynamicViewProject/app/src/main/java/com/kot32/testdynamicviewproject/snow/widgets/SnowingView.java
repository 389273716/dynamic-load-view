package com.kot32.testdynamicviewproject.snow.widgets;
...
import com.kot32.testdynamicviewproject.snow.utils.DensityUtil;
import com.kot32.testdynamicviewproject.snow.utils.RandomUtil;
...
public class SnowingView extends View implements SensorEventListener {
    ...
    private void applyAttrsFromXML(TypedArray array) {
        mSnowFlakeBitmap = ((BitmapDrawable) getResources().getDrawable(R.drawable.ic_snowflake)).getBitmap();
        Log.e("getResources:", getResources() + "");
        Log.e("Drawable:", "" + getResources().getDrawable(R.drawable.ic_snowflake));
        Log.e("Bitmap:", "" + ((BitmapDrawable) getResources().getDrawable(R.drawable.ic_snowflake)).getBitmap());
        if (mSnowFlakeBitmap == null) {
            mSnowFlakeBitmap = ((BitmapDrawable) getResources().getDrawable(R.drawable.test)).getBitmap();
        }
